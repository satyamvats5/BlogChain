...
var blockchaindata1=document.querySelector("#blockchaindata1");
...
var blockchaindata2=document.querySelector("#blockchaindata2");
...
blockchain1.addEventListener("keyup", function() {
  for (var i = 0; i < blockchainshell.length; i++) {
  ...
  blockchainhash1.value=SHA256(blockchain1.value+blockchainnonce1.value+blockchaindata1.value);
  blockchainprev2.value=blockchainhash1.value;
  blockchainhash2.value=SHA256(blockchain1.value+blockchainnonce1.value+blockchaindata1.value+blockchain2.value+blockchainnonce2.value+blockchaindata2.value);
});
...
blockchaindata1.addEventListener("keyup", function() {
  for (var i = 0; i < blockchainshell.length; i++) {
    blockchainshell[i].style.background="#EBDEF0";
  }
  for (var i = 0; i < blockrow.length; i++) {
...
mine1.addEventListener("click", function() {
  for (var i = 0; i <= 2147483647; i++) {
    var s=SHA256(blockchain1.value+i+blockchaindata1.value);
    if(s.substring(0,4)==="0000"){
      ...
      for (var i = 0; i < 1; i++) {
        mine[i].style.background="#D1F2EB";
      }
      break;
    }
  }
...
blockchain2.addEventListener("keyup", function() {
  for (var i = 1; i < blockchainshell.length; i++) {
    blockchainshell[i].style.background="#EBDEF0";
  }
  for (var i = 6; i < blockrow.length; i++) {
    blockrow[i].style.borderColor="#EBDEF0";
  }
  for (var i = 0; i < transactionrow.length; i++) {
    transactionrow[i].style.borderColor="#EBDEF0";
...
blockchaindata2.addEventListener("keyup", function() {
  for (var i = 1; i < blockchainshell.length; i++) {
    blockchainshell[i].style.background="#EBDEF0";
  }
  for (var i = 6; i < blockrow.length; i++) {
...
mine2.addEventListener("click", function() {
  for (var i = 0; i <= 2147483647; i++) {
    var s=SHA256(blockchain1.value+blockchainnonce1.value+blockchaindata1.value+blockchain2.value+i+blockchaindata2.value);
    if(s.substring(0,4)==="0000"){
